        ...
        >
          ...
          >
            ...
            <div className="flex shrink-0 items-center justify-between">
              ...
              <span
                className="rounded-full border px-3 py-1 text-[8px] font-bold uppercase tracking-[2px]"
                style={{
                  borderColor:
                    accentOnLight,
                  color:
              ...
              {safePoints.map(
                (
                  ...
                  >
                    ...
                    <p
                      className="mt-3 shrink-0 text-[8px] font-bold uppercase tracking-[2px]"
                      style={{
                        color:
                          accentOnLight,
                      }}
            ...
            {/* Footer */}
            <div
              className="mt-5 flex shrink-0 items-center justify-between border-t pt-4 text-[8px] text-[#81766A]"
              style={{
                borderColor:
                  branded
                    ? accentOnLight
