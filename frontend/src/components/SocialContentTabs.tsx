...
export default function SocialContentTabs({
  ...
  const content = {
    linkedin: {
      ...
      option1: linkedin1,
      option2: linkedin2,
      story1: linkedinStory1,
      story2: linkedinStory2,
    },
    x: {
      label: "X",
      description:
    ...
    instagram: {
      ...
      option1: instagram1,
      option2: instagram2,
      story1: instagramStory1,
      story2: instagramStory2,
    },
  };
...
function PostOption({
  ...
  return (
    <article className="flex min-h-[320px] flex-col rounded-[24px] border border-[#E5DED3] bg-white p-6">
      ...
      <div className="mt-4 rounded-[18px] bg-[#F7F3EC] p-4">
        <p className="text-[10px] font-bold uppercase tracking-[2px] text-[#9A8167]">
          {story.source}
        </p>

        <p className="mt-2 text-sm font-semibold leading-5 text-[#302C28]">
          {story.title}
        </p>
      ...
      <div className="mt-5 flex-1 whitespace-pre-wrap text-sm leading-7 text-[#514A43]">
        {content ||
